            ...
            <div style={{
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 20 }}>
                    <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                        ...
                        <div>
                            <h3 style={{ ...S.title(18, '#fff'), marginBottom: 4 }}>Uma Etapa de Cada Vez</h3>
                            <p style={{ fontSize: 14, color: '#777', lineHeight: 1.5 }}>Faça o seu treino de hoje, sem se preocupar com o de amanhã. Não tente acelerar, adapte-se ao processo.</p>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                        ...
                        <div>
                            <h3 style={{ ...S.title(18, '#fff'), marginBottom: 4 }}>Descanso também é treino</h3>
                            <p style={{ fontSize: 14, color: '#777', lineHeight: 1.5 }}>Nossa plataforma calcula os seus dias de repouso na semana. Respeite-os, os músculos crescem durante a recuperação.</p>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                        ...
                        <div>
                            <h3 style={{ ...S.title(18, '#fff'), marginBottom: 4 }}>Só Vale Hoje</h3>
                            <p style={{ fontSize: 14, color: '#777', lineHeight: 1.5 }}>Bloqueamos treinos em dias passados ou futuros. O compromisso é agora.</p>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Smartphone color="#fff" size={36} />
            </div>

            <h1 style={{ ...S.title(32), lineHeight: 1.2, marginBottom: 16 }}>
                USE COMO UM APP
            </h1>
            <p style={{ fontSize: 16, color: '#aaa', lineHeight: 1.6, marginBottom: 40, maxWidth: 320 }}>
            ...
            <div style={{ background: '#111', borderRadius: 16, padding: 20, width: '100%', maxWidth: 320, marginBottom: 40, textAlign: 'left' }}>
                <p style={{ ...S.label(), marginBottom: 12 }}>COMO ADICIONAR (iOS / ANDROID)</p>
                <ol style={{ paddingLeft: 20, margin: 0, color: '#888', fontSize: 14, lineHeight: 1.8 }}>
                    <li>Toque no botão de compartilhar (ou três pontos) no seu navegador.</li>
                    <li>Encontre e selecione <span style={{ color: '#fff', fontWeight: 600 }}>"Adicionar à Tela Inicial"</span>.</li>
            ...
            <button
                onClick={onComplete}
                style={{
                    ...S.btn('#fff', 'lg'), color: '#000', width: '100%', maxWidth: 320,
